...
export default function MipulPage() {
  const PHONE_DISPLAY = "11 3779 8582";
  const PHONE_TEL = "+541137798582";
  const WHATSAPP_URL = "https://wa.me/5491137798582?text=Hola%20MIPUL%2C%20necesito%20un%20servicio";
      ...
      <main className="min-h-screen bg-white text-zinc-900">
        ...
        <header className="border-b">
          <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              <a href={`tel:${PHONE_TEL}`} className="rounded-xl px-4 py-2 border">Llamar</a>
            </div>
          </div>
        </header>
        ...
        <section className="py-10 bg-emerald-50">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-zinc-700 mt-2">Respondemos rápido por WhatsApp o llamada.</p>
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              <a href={WHATSAPP_URL} className="rounded-2xl px-6 py-3 bg-emerald-600 text-white hover:bg-emerald-700">Contactar por WhatsApp</a>
              <a href={`tel:${PHONE_TEL}`} className="rounded-2xl px-6 py-3 border">Llamar ahora</a>
            </div>
          </div>
        </section>
